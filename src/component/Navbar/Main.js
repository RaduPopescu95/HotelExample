                                    ...
                                    <div className="main-menu text-center">
                                        <nav id="mobile-menu ">
                                            <ul>
                                                ...
                                                <li className="has-sub"><Link to="/about">Despre noi</Link></li>
                                                <li className="has-sub">
                                                ...
                                                <li className="has-sub"><Link to="/gallery">Galerie</Link></li>
                                                ...
                                                <li className="has-sub"><Link to="/contact">Contact</Link></li>
                                            </ul>
                                        </nav>
                                    </div>
                                </div>
                                <div className="col-xl-2 col-lg-2 d-none d-lg-block">
                                    <Link to="/room" className="top-btn mt-10 mb-10">Rezervă</Link>
                                </div>
